...
sceneFourTL.to("#marathead-4", 0.5, {rotation: "-=10", ease: Power1.easeOut, y: -2, delay: 1})
           ...
           .to("#marat-d4-1", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
           .to("#marat-d4-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: 1})
           .to("#marat-d4-2", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 3})
           ...
           .to("#alexei-d4-3", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 5})
           .to("#alexei-d4-4", 0.5,{autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .to("#alexei-d4-4", 0.5,{autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay:2})
           ...
           .to("#marat-d4-5", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
           .to("#alexei-head-4", 0.5, {rotation: "-=10", ease: Power1.easeOut})
           .to("#blue-circle-4", 0.2, {autoAlpha: 0.5, x: -500, ease: Power1.easeOut})
           .to("#alexei-d4-6", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .to("#alexei-d4-6", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 5})
           .to("#alexei-d4-7", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .to("#alexei-d4-7", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 5})
...
sceneSixTL.to("#yaroslav-d6-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: 1})
          ...
          .to("#yaroslav-d6-1", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
          .to("#yaroslav-d6-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: 1})
          .to("#yaroslav-d6-2", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
...
sceneNineTL.to("#alexei-head-9", 0.5, {rotation: 12, ease: Sine.easeOut, delay: 1}, "alexei-head-speak")
           ...
           .to("#alexei-d9-1", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
           .to("#marat-d9-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .to("#marat-d9-2", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
           .to("#alexei-head-9", 0.5, {rotation: 2, ease: Sine.easeOut})
           .to("#marat-d9-3", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .to("#marat-d9-3", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
           .to("#yaroslav-d9-4", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .to("#yaroslav-d9-4", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2});
...
sceneNineGrooveTwoTL.to("#cta-9", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5}, "out")
                    ...
                    .to("#marat-d9-5", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
                    .to("#alexei-d9-6", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
                    .to("#alexei-d9-6", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
                    ...
                    .to("#yaroslav-d9-7", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 2})
...
sceneElevenTL.to("#yaroslav-head-11", 0.3, {rotation: 6, ease: Sine.easeOut, y: -2, x: 4}, "yaroslav11-1")
             ...
             .to("#yaroslav-d11-1", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
             ...
             .to("#marat-d11-2", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
...
sceneTwelveTL.from("#sectionTwelve", 2, {autoAlpha: 0})
             ...
             .to("#alexei-d12-4", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 4})
             ...
             .to("#marat-d12-5", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 2})
...
sceneFourteenTL.to("#presenter-d14-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .to("#presenter-d14-1", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#presenter-d14-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .to("#presenter-d14-2", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#presenter-d14-3", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .to("#presenter-d14-3", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
...
sceneFifteenTL.to("#presenter-d15-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .to("#presenter-d15-1", 0.5, {autoAlpha: 0, delay: 3})
              .to("#presenter-d15-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .to("#presenter-d15-2", 0.5, {autoAlpha: 0, delay: 3})

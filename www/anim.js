...
sceneOneTL.to("#tomsk", 8, {x: -800, ease: Back.easeOut.config(1.7)})
          ...
          .to("#tomsk-txt", 5, {autoAlpha: 1, ease: Back.easeOut}, "-=10")
          .to("#tomsk", 10, {scale: 3, ease: ExpoScaleEase.config(1, 3)}, "-=10")
          .to("#tomsk-txt", 3, {autoAlpha: 0, ease: Back.easeOut}, "-=3")
          .to("#tomsk", 5, {autoAlpha: 0, ease: Back.easeOut}, "-=3")
          .to("#big-stripes", 8, {autoAlpha: 0, ease: Back.easeOut}, "-=3")
          .to("#section1BtnFwd", 5, {autoAlpha:1}, "-=7")
					.to("#logo-1", 3, {autoAlpha: 1 }, "-=8");
...
sceneTwoTL.to("#alexei-head", 0.5, {rotation: "-=20", ease: Power1.easeOut, y: -8, x: -2, delay: 1})
					.to("#alexei-d2", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -10})
					.to("#blue-circle", 1, {autoAlpha: 0.5, delay: -1})
					.to("#section2BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20})
          .to("#section2BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20, delay: -1});
...
sceneFourTL.to("#marathead-4", 0.5, {rotation: "-=10", ease: Power1.easeOut, y: -2, delay: 1})
           .to("#blue-circle-4", 0.2, {autoAlpha: 0.5, y: 100, ease: Power1.easeOut})
           .to("#marat-d4-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: 1})
           .from("#marat-d4-1", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
           .to("#marat-d4-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: 1})
           .from("#marat-d4-2", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 3})
           .to("#blue-circle-4", 0.2, {autoAlpha: 0.5, x: -500, ease: Power1.easeOut})
           .to("#alexei-head-4", 0.5, {rotation: "-=20", ease: Power1.easeOut, y: -8, x: -2})
           .to("#alexei-d4-3", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .from("#alexei-d4-3", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 5})
           .to("#alexei-d4-4", 0.5,{autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .from("#alexei-d4-4", 0.5,{autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay:2})
           .to("#blue-circle-4", 0.2, {autoAlpha: 0.5, x: 50, ease: Power1.easeOut})
           .to("#marathead-4", 0.5, {rotation: "+=5", ease: Power1.easeOut})
           .to("#marat-d4-5", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .from("#marat-d4-5", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
           .to("#alexei-head-4", 0.5, {rotation: "-=10", ease: Power1.easeOut})
           .to("#blue-circle-4", 0.2, {autoAlpha: 0.5, x: -500, ease: Power1.easeOut})
           .to("#alexei-d4-6", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .from("#alexei-d4-6", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 5})
           .to("#alexei-d4-7", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .from("#alexei-d4-7", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 5})
           ...
           .to("#section4BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20, delay: -1})
           .to("#section4BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneFiveTL.from("#alexei-head-5", 0.5, {rotation: "-=20"})
           .from("#blue-circle-5", 0.4, {x: 100, autoAlpha: 0, ease: Power1.easeOut})
           .from("#pink-circle-5", 0.4, {x: -100, autoAlpha: 0, ease: Power1.easeOut, delay: -0.5})
           .from("#alexeis-pc", 0.4, {scale: 0.1, autoAlpha: 0, ease: Bounce.easeOut, delay: -0.2})
           .to("#hey-big-5", 0.4, {scale: 1.5, autoAlpha: 1, ease: Power1.easeOut})
           .to("#not-there-5", 0.4, {autoAlpha: 1, ease: Bounce.easeOut})
           .to("#section5BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
           .to("#section5BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneSixTL.to("#yaroslav-d6-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: 1})
          .to("#yaroslav-head-6", 0.3, {rotation: 6, ease: Sine.easeOut, y: -2, x: 4, delay: -0.5})
          .from("#yaroslav-d6-1", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
          .to("#yaroslav-d6-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: 1})
          .from("#yaroslav-d6-2", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
          .to("#yaroslav-d6-3", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: 1})
          .to("#yaroslav-head-6", 0.3, {rotation: -10, ease: Sine.easeOut, y: 2, x: -9, delay: -0.5})
          .from("#yaroslav-d6-3", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
          .to("#marat-d6-4", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: 1})
          .to("#marathead-6", 0.5, {rotation: 8, ease: Sine.easeOut, delay: -0.5})
          .from("#marat-d6-4", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
          .to("#alexei-head-6", 0.5, {rotation: 12, ease: Sine.easeOut})
          .to("#alexei-d6-5", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5, delay: -0.5})
          .from("#alexei-d6-5", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
          .to("#section6BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
          .to("#section6BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneSevenTL.from("#big-stripes-7", 1, {y: 300, autoAlpha: 0, ease: Sine.easeOut})
            .from("#yaroslav-mob", 1, {y: 300, autoAlpha: 0, ease: Sine.easeOut, delay: -0.5})
            .from("#blue-circle-7", 0.5, {x: 50, autoAlpha: 0, ease: Sine.easeOut, delay: -0.5})
            .from("#pink-circle-7", 0.5, {x: -50, autoAlpha: 0, ease: Sine.easeOut, delay: -0.5})
            .from("#deleted-us-7", 0.8, {autoAlpha: 0, y: 10, ease:RoughEase.ease})
            .to("#section7BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
            .to("#section7BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneEightTL.from("#pink-circle-8", 1, {x: 300, autoAlpha: 0, ease: Power1.easeOut})
            .to("#blue-circle-8", 1, {autoAlpha: 1, ease: Power1.easeOut, delay: -1})
            .from("#stripes-8", 2, {x: 20, ease: Sine.easeOut})
            .to("#deleting1", 0.8, {y: 10, autoAlpha: 1, ease:RoughEase.ease, delay: -1})
            .to("#overlay-8", 0.5, {autoAlpha: 1, scale: 3, ease: Sine.easeOut, delay: -0.5})
            .to("#overlay-8", 0.5, {scale: 2, ease: Sine.easeOut.ease})
            .to("#section8BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
            .to("#section8BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1})
...
sceneNineTL.to("#alexei-head-9", 0.5, {rotation: 12, ease: Sine.easeOut, delay: 1}, "alexei-head-speak")
           .to("#alexei-d9-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-speak")
           .from("#alexei-d9-1", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
           .to("#marat-d9-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .from("#marat-d9-2", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
           .to("#alexei-head-9", 0.5, {rotation: 2, ease: Sine.easeOut})
           .to("#marat-d9-3", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .from("#marat-d9-3", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
           .to("#yaroslav-d9-4", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
           .from("#yaroslav-d9-4", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2});
...
sceneNineGrooveOneTL.fromTo("#alexei-head-9", 0.8, {rotation: 0}, {rotation: 5, ease: Bounce.easeOut, repeat: -1},"alexei-intro")
                    ...
                    .to("#baltic-funk-bg-9", 2, {autoAlpha: 1, ease: RoughEase.ease.config({ template:
                        Power0.easeNone, strength: 1, points: 20, taper: "none", randomize: true, clamp: false})}, "balticFunk9")

                    .to("#baltic-funk-9", 3, {autoAlpha: 0.9, y: 0.1, ease: RoughEase.ease.config({ template:
                            Power0.easeNone, strength: 1, points: 20, taper: "none", randomize: true, clamp: false})}, "balticFunk9")

                    .to("#baltic-funk-bg-9", 2, {autoAlpha: 0, ease: RoughEase.ease.config({ template:
                                Power0.easeNone, strength: 1, points: 20, taper: "none", randomize: true, clamp: false}), delay: 1}, "bFunk9Out")

                    .to("#baltic-funk-9", 3, {autoAlpha: 0, ease: RoughEase.ease.config({ template:
                    ...
                    .to("#logo-9", 1, {autoAlpha: 0.5, ease: RoughEase.ease.config({ template:
                      Power0.easeNone, strength: 1, points: 20, taper: "none", randomize: true, clamp: false}), y: -2, delay: 20})
                    .to("#logo-9", 1, {autoAlpha: 0, ease: RoughEase.ease.config({ template:
...
sceneNinePromptTL.to("#cta-9", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "prompt-in")
                 .to("#yesbtn-9", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "prompt-in")
                 .to("#nobtn-9", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "prompt-in");
...
sceneNineGrooveTwoTL.to("#cta-9", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5}, "out")
                    .to("#yesbtn-9", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5},"out")
                    .to("#nobtn-9", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5}, "out")
                    ...
                    .to("#marat-d9-5", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
                    .from("#marat-d9-5", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
                    .to("#alexei-d9-6", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
                    .from("#alexei-d9-6", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, y: -5, delay: 2})
                    .to("#section9", 5, {scale: 1.4, y: 100, ease: ExpoScaleEase.config(1, 1.4, Power2.easeInOut)})
                    .to("#yaroslav-d9-7", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
                    .from("#yaroslav-d9-7", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 2})
                    .to("#section9", 3, {scale: 1, y: 0, ease: ExpoScaleEase.config(1.4, 1, Power2.easeInOut), delay: 2});

sceneNineBtnsTL.to("#section9BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20},"in")
               .to("#section9BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});

sceneNineCTLGo.to("#cta-9", 0.2, {autoAlpha: 0, ease: Bounce.easeOut, y: -5}, "go")
              .to("#yesbtn-9", 0.2, {autoAlpha: 0, ease: Bounce.easeOut, y: -5}, "go")
              .to("#nobtn-9", 0.2, {autoAlpha: 0, ease: Bounce.easeOut, y: -5}, "go");


sceneNineBtnsGoTL.to("#section9BtnFwd", 1, {autoAlpha: 0, ease: Bounce.easeOut, y: 20})
                 .to("#section9BtnBck", 1, {autoAlpha: 0, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneTenTL.from("#big-stripes-10", 1,{y: 200, opacity: 0})
          .from("#text-10", 0.5, {autoAlpha: 0, y: 50, ease: RoughEase.ease.config({ template:
                Power0.easeNone, strength: 1, points: 20, taper: "none", randomize: true, clamp: false})})
          .from("#pie-chart-10", 0.5, {autoAlpha: 0, y: 50, ease: RoughEase.ease.config({ template:
                Power0.easeNone, strength: 1, points: 20, taper: "none", randomize: true, clamp: false})})
          .to("#section10BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
          .to("#section10BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneElevenTL.to("#yaroslav-head-11", 0.3, {rotation: 6, ease: Sine.easeOut, y: -2, x: 4}, "yaroslav11-1")
             .to("#yaroslav-d11-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "yaroslav11-1")
             .from("#yaroslav-d11-1", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
             .to("#marathead-11", 0.3, {rotation: 5, ease: Sine.easeOut}, "marat11-1")
             .to("#marat-d11-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat11-1")
             .from("#marat-d11-2", 0.5, {autoAlpha: 0, ease:Bounce.easeOut, delay: 2})
             ...
             .to("#section11BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
             .to("#section11BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneTwelveTL.from("#sectionTwelve", 2, {autoAlpha: 0})
             .from("#pink-stripes-12", 1, {y: 100, autoAlpha: 0})
             .to("#alexei-12", 0.5, {rotation: -10}, "alexei-head-12")
             .to("#make-an-12", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5},"alexei-head-12")
             .to("#make-an-12", 0.5, {autoAlpha: 0, delay: 2})
             .to("#marat-head-12", 0.5, {rotation: 10}, "marat-d12-1-nod")
             .to("#marat-d12-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-d12-1-nod")
             .from("#marat-d12-1", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 2})
             .to("#alexei-12", 0.5, {rotation: -5})
             .to("#alexei-d12-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
             .from("#alexei-d12-2", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 2})
             .to("#marat-head-12", 0.5, {rotation: -5}, "marat-d12-2-nod")
             .to("#marat-d12-3", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-d12-2-nod")
             .from("#marat-d12-3", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 2})
             .to("#alexei-d12-4", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-d12")
             .to("#alexeis-pc-screen-12", 6, {autoAlpha: 1, ease: RoughEase.ease.config({ template:
                   Power0.easeNone, strength: 1, points: 20, taper: "none", randomize: true, clamp: false})}, "alexei-d12")
             .from("#alexei-d12-4", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 4})
             .to("#marat-head-12", 0.5, {rotation: -15, delay: -2}, "marat-d12-3-nod")
             .to("#marat-d12-5", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-d12-3-nod")
             .from("#marat-d12-5", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 2})
             .to("#section12BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
             .to("#section12BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneThirteenTL.to("#marat-head-13", 1, {rotation: 10, y: 5})
               .to("#marat-d13-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               ...
               .to("#blue-circle-13", 1, {autoAlpha: 1, ease: RoughEase.ease.config({ template:
                     Power0.easeNone, strength: 1, points: 20, taper: "none", randomize: true, clamp: false})}, "dance")
               .to("#section13BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
               .to("#section13BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneFourteenTL.to("#presenter-d14-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .from("#presenter-d14-1", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#presenter-d14-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .from("#presenter-d14-2", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#presenter-d14-3", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .from("#presenter-d14-3", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#marat-tache-14", 0.5, {rotation: 20})
               .to("#marat-tache-14", 0.5, {rotation: -30})
               .to("#marat-tache-14", 0.5, {rotation: -3})
               .to("#presenter-d14-4", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .from("#presenter-d14-4", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#marat-face-14", 0.5, {rotation: 10}, "marat-head-14-1")
               .to("#marat-d14-5", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-head-14-1")
               .from("#marat-d14-5", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#marat-face-14", 0.5, {rotation: -5}, "marat-head-14-2")
               .to("#marat-d14-6", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-head-14-2")
               .from("#marat-d14-6", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#presenter-d14-7", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .from("#presenter-d14-7", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#marat-face-14", 0.5, {rotation: -10}, "marat-head-14-3")
               .to("#marat-d14-8", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .from("#marat-d14-8", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#marat-face-14", 0.5, {rotation: -5}, "marat-head-14-4")
               .to("#marat-d14-9", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5},"marat-head-14-4")
               .from("#marat-d14-9", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#marat-face-14", 0.5, {rotation: 5}, "marat-head-14-5")
               .to("#marat-d14-10", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-head-14-5")
               .from("#marat-d14-10", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#alexei-14", 0.5, {rotation: 5}, "alexei-head-14-1")
               .to("#alexei-d14-11", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-14-1")
               .from("#alexei-d14-11", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#alexei-14", 0.5, {rotation: -5}, "alexei-head-14-2")
               .to("#alexei-d14-12", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-14-2")
               .from("#alexei-d14-12", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#presenter-d14-13", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .from("#presenter-d14-13", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#presenter-d14-14", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .from("#presenter-d14-14", 0.5, {autoAlpha: 0, ease: Bounce.easeOut, delay: 3})
               .to("#section14BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
               .to("#section14BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneFifteenTL.to("#presenter-d15-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d15-1", 0.5, {autoAlpha: 0, delay: 3})
              .to("#presenter-d15-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d15-2", 0.5, {autoAlpha: 0, delay: 3})
              .to("#section15BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
              .to("#section15BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneSixteenTL.to("#marat-face-16", 0.5, {rotation: 10}, "marat-head-16-1")
              .to("#marat-d16-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-head-16-1")
              .from("#marat-d16-1", 0.5, {autoAlpha: 0, delay: 3})

              .to("#marat-face-16", 0.5, {rotation: -5}, "marat-head-16-2")
              .to("#marat-d16-2", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-head-16-2")
              .from("#marat-d16-2", 0.5, {autoAlpha: 0, delay: 3})

              .to("#presenter-d16-3", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-3", 0.5, {autoAlpha: 0, delay: 3})

              .to("#marat-face-16", 0.5, {rotation: -10}, "marat-head-14-3")
              .to("#marat-d16-4", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-head-14-3")
              .from("#marat-d16-4", 0.5, {autoAlpha: 0, delay: 3})

              .to("#alexei-16", 0.5, {rotation: 5}, "alexei-head-16-1")
              .to("#alexei-d16-5", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-16-1")
              .from("#alexei-d16-5", 0.5, {autoAlpha: 0, delay: 3})

              .to("#alexei-16", 0.5, {rotation: -5}, "alexei-head-16-2")
              .to("#alexei-d16-6", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-16-2")
              .from("#alexei-d16-6", 0.5, {autoAlpha: 0, delay: 3})

              .to("#alexei-16", 0.5, {rotation: 5}, "alexei-head-16-3")
              .to("#alexei-d16-7", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-16-3")
              .from("#alexei-d16-7", 0.5, {autoAlpha: 0, delay: 3})

              .to("#presenter-d16-8", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-8", 0.5, {autoAlpha: 0, delay: 3})

              .to("#alexei-16", 0.5, {rotation: -3}, "alexei-head-16-4")
              .to("#alexei-d16-9", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-16-4")
              .from("#alexei-d16-9", 0.5, {autoAlpha: 0, delay: 3})

              .to("#alexei-16", 0.5, {rotation: -3}, "alexei-head-16-5")
              .to("#alexei-d16-10", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-16-5")
              .from("#alexei-d16-10", 0.5, {autoAlpha: 0, delay: 3})

              .to("#presenter-d16-11", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-11", 0.5, {autoAlpha: 0, delay: 3})

              .to("#marat-face-16", 0.5, {rotation: -5}, "marat-head-14-4")
              .to("#marat-d16-12", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-head-14-4")
              .from("#marat-d16-12", 0.5, {autoAlpha: 0, delay: 4})

              .to("#marat-face-16", 0.5, {rotation: -2}, "marat-head-14-5")
              .to("#marat-d16-13", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-head-14-5")
              .from("#marat-d16-13", 0.5, {autoAlpha: 0, delay: 3})

              .to("#marat-face-16", 0.5, {rotation: 5}, "marat-head-14-6")
              .to("#presenter-d16-14", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-14", 0.5, {autoAlpha: 0, delay: 3})

              .to("#alexei-16", 0.5, {rotation: 3}, "alexei-head-16-6")
              .to("#alexei-d16-15", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-16-6")
              .from("#alexei-d16-15", 0.5, {autoAlpha: 0, delay: 3})

              .to("#alexei-16", 0.5, {rotation: -5}, "alexei-head-16-7")
              .to("#alexei-d16-16", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-16-7")
              .from("#alexei-d16-16", 0.5, {autoAlpha: 0, delay: 3})

              .to("#alexei-16", 0.5, {rotation: 3}, "alexei-head-16-8")
              .to("#alexei-d16-17", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "alexei-head-16-8")
              .from("#alexei-d16-17", 0.5, {autoAlpha: 0, delay: 3})

              .to("#presenter-d16-18", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-18", 0.5, {autoAlpha: 0, delay: 3})

              .to("#presenter-d16-19", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-19", 0.5, {autoAlpha: 0, delay: 3})

              .to("#marat-face-16", 0.5, {rotation: -4}, "marat-head-14-7")
              .to("#marat-d16-20", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5}, "marat-head-14-7")
              .from("#marat-d16-20", 0.5, {autoAlpha: 0, delay: 3})

              .to("#presenter-d16-21", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-21", 0.5, {autoAlpha: 0, delay: 3})

              .to("#presenter-d16-22", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-22", 0.5, {autoAlpha: 0, delay: 3})

              .to("#presenter-d16-23", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-23", 0.5, {autoAlpha: 0, delay: 2})

              .to("#presenter-d16-24", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-24", 0.5, {autoAlpha: 0, delay: 3})

              .to("#presenter-d16-25", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
              .from("#presenter-d16-25", 0.5, {autoAlpha: 0, delay: 3})

              .to("#section16BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
              .to("#section16BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneSeventeenTL.fromTo("#marat-head-17", 0.5, {y: 0.1, rotation: 1}, {y: -1, rotation: 3, ease: Sine.easeOut, repeat: -1}, "marathead17")
                ...
                .fromTo("#glitch", 3, {autoAlpha: 0.3}, {autoAlpha: 0, ease: RoughEase.ease.config({ template:
                ...
                .to("#good-evening-russia-17", 3, {autoAlpha: 0.8})
                .to("#section17BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
                .to("#section17BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
...
sceneEighteenTL.to("#alexeis-phone-18", 0.5, {autoAlpha: 1, ease: Sine.easeOut, delay: 2}, "start-18")
               .from("#blue-circle-18", 1, {autoAlpha: 0, x: 500, ease: Sine.easeOut}, "start-18")
               .to("#alexei-d18-1", 0.5, {autoAlpha: 1, ease: Bounce.easeOut, y: -5})
               .to("#section18BtnFwd", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: 20})
               .to("#section18BtnBck", 1, {autoAlpha: 1, ease: Bounce.easeOut, y: -20, delay: -1});
